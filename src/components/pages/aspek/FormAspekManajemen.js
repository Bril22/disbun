    ...
    <>
      ...
      <div className="mt-6">
        <InputForm
          ...
          } w-[80%] rounded border bg-white-2 py-3  px-6 text-black placeholder:text-base`}
          iconEmail="true"
        />
      </div>
      <div className="mt-6">
      ...
      <button className="mt-6 w-[80%] rounded-md bg-white p-4 text-sm font-bold text-primary-green outline outline-1">
        + Tambah Komisaris
      </button>
      ...
      {/* Section 3 */}
      <div className="mt-12 text-base text-primary-black-2">Tenaga Kerja</div>
      <div className="mt-6 grid w-[80%] grid-cols-3 gap-2">
        <InputForm
      ...
      <div className="mt-6 text-base text-blue-600">
        <a href="/aspek/manajemen">Struktur Organisasi dan Nama Pengelola</a>
      </div>
      <div className="mt-6 grid w-[80%] grid-cols-2 gap-2">
        <InputForm
